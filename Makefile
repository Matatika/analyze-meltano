...
datasets:
	...
	mv matatika-dataset-to-html/matatika_dataset_to_html.py bundle/analyze/datasets/tap-meltano/
	source venv/bin/activate && python bundle/analyze/datasets/tap-meltano/matatika_dataset_to_html.py --datasets bundle/analyze/datasets/tap-meltano/ --rawdata rawdata/ || python bundle/analyze/datasets/tap-meltano/matatika_dataset_to_html.py --datasets bundle/analyze/datasets/tap-meltano/ --rawdata rawdata/
	rm -rf matatika-dataset-to-html
	rm bundle/analyze/datasets/tap-meltano/matatika_dataset_to_html.py
clean:
	rm -rf matatika-dataset-to-html
	rm bundle/analyze/datasets/tap-meltano/matatika_dataset_to_html.py
